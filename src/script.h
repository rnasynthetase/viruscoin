...
#ifndef H_VIRUSCOIN_SCRIPT
#define H_VIRUSCOIN_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CViruscoinAddress
 */
...
public:
    ...
    // Pre-version-0.6, Viruscoin always counted CHECKMULTISIGs
