...
unlocked to sign the Viruscoin-Qt.app bundle.
...
allowing somebody to distribute a Viruscoin-Qt.app or viruscoin-qt-setup.exe with a valid
...
that the viruscoin-qt.exe file inside the installer had not been tampered with.
